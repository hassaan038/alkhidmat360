...
export default function FormSection({
  ...
  return (
    <section
      className={cn(
        'rounded-2xl border border-gray-200 bg-white shadow-card overflow-hidden',
        className
      )}
    >
      {(title || description) && (
        <header className="flex items-start justify-between gap-4 border-b border-gray-100 px-5 py-4 sm:px-6">
          <div className="flex items-start gap-3 min-w-0">
            {(Icon || step) && (
              <div className="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-lg bg-primary-50 text-primary-600 font-semibold text-sm">
